		...
		<>
			...
			<div className="race-layout">
				...
				<RaceTimers
					...
					numUninterruptedLaps={stats.teamA.numUninterruptedLaps}
				...
				<RaceTimers
					...
					numUninterruptedLaps={stats.teamB.numUninterruptedLaps}
	...
	return (
		<div className="race-layout">
			...
			<RaceTimers
				...
				numUninterruptedLaps={stats.numUninterruptedLaps}
