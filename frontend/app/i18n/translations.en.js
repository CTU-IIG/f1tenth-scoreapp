...
export default {
	...
	racePage: {
		...
		onlyBarrierA: `Only barrier A`,
		onlyBarrierB: `Only barrier B`,
	...
	newRaceForm: {
		labels: {
			type: `Type`,
			team: `Team`,
			teamBarrierId: `Team home barrier ID`,
			teamA: `Team A`,
			teamABarrierId: `Team A home barrier ID`,
			teamB: `Team B`,
			teamBBarrierId: `Team B home barrier ID`,
			round: `Heat`,
			minLapTime: `Minimum lap time`,
			timeDuration: `Time duration`,
			lapsDuration: `Laps duration`,
		},
		minLapTimeNote: `Enter duration in number of milliseconds (e.g. 5000 means 5 seconds). Enter 0 (zero) for an unlimited duration.`,
