...
const store = new Store<AppState>({
	version: '0.0.7', // TODO: consider using build hash
	onInitData: () => typedMapConstructor([
		...
		// ['restUrl', 'http://195.0.0.41:4110'],
		// ['webSocketUrl', 'ws://195.0.0.41:4110/ws'],
		['restUrl', 'http://192.168.1.2:4110'],
		['webSocketUrl', 'ws://192.168.1.2:4110/ws'],
		['authToken', undefined],
		['soundEffects', true],
	]),
});
